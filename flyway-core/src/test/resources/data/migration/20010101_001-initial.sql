...
ALTER TABLE `example`.`article_image` CHANGE COLUMN `thumb_url` `thumb_url` TEXT NOT NULL AFTER `article_id`;
ALTER TABLE `example`.`article_image` MODIFY COLUMN `thumb_url` VARCHAR(512) NOT NULL AFTER `article_id`;
...
ALTER TABLE `example`.`article_image` RENAME /* CONSTRAINT */ INDEX `ARTICLE_IMAGE-ARTICLE_ID` TO `ARTICLE_IMAGE-ARTICLE_ID-RENAMED`;
ALTER TABLE `example`.`article_image` DROP /* CONSTRAINT */ INDEX `ARTICLE_IMAGE-ARTICLE_ID-RENAMED`;
